...
public class JacocoHealthReportDeltaThresholdsTest {
    ...
    private CTHealthReportDeltaThresholds jacocoHealthReportDeltaThresholds;

    @Before
    public void setUp() {
        this.jacocoHealthReportDeltaThresholds = new CTHealthReportDeltaThresholds("10.0555503", "-1", "5.0647928", "190.90", "2.0222", "0");
    }
