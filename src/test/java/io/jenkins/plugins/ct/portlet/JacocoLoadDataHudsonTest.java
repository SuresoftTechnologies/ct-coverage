...
/**
 * Tests {@link io.jenkins.plugins.ct.portlet.CTLoadData} in a Hudson environment.
 *
...
*/
     ...
     * Tests {@link io.jenkins.plugins.ct.portlet.CTLoadData#getResultSummary(java.util.Collection)}.
    ...
    public void testGetResultSummary() throws Exception {
        ...
        CTCoverageResultSummary coverageResultSummary = new CTCoverageResultSummary(
        		null, lineCoverage, methodCoverage,  branchCoverage,  complexityScore);
        assertNotNull(coverageResultSummary);

        // create a result summary with data from the second emma action
        CTCoverageResultSummary coverageResultSummary2 = new CTCoverageResultSummary(
        		null, lineCoverage2, methodCoverage2,  branchCoverage2, complexityScore2);
