package io.jenkins.plugins.ct.portlet.utils;
...
/**
 * Test {@link io.jenkins.plugins.ct.portlet.utils.Utils}
...
public class UtilsHudsonTest extends HudsonTestCase {
  ...
  /**
   * Tests {@link io.jenkins.plugins.ct.portlet.utils.Utils#getLastDate(java.util.List) }.
  ...
  /**
   * Tests {@link io.jenkins.plugins.ct.portlet.utils.Utils#roundFloat(int scale, RoundingMode roundingMode, float value) }.
   */
